      ...
      <div className="mt-2">
        <div className="relative rounded-md ">
          ...
          <input
            ...
            className={cn(
              "block w-full rounded-md border-2 p-2 py-2 bg-white text-gray-900 shadow-sm placeholder:text-gray-400 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 text-sm",
