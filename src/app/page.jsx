...
export default function HomePage() {
  ...
  const prevLuxury = () => {
    setLuxuryCarouselIndex((prev) =>
      prev === 0 ? luxuryDevelopments.length - 1 : prev - 1
    );
  };
  ...
  const prevLaunch = () => {
    setLaunchCarouselIndex((prev) =>
      prev === 0 ? latestLaunches.length - 1 : prev - 1
    );
  };
  ...
  return (
    <>
      {" "}
      <section className="relative h-72 sm:h-96 md:h-[600px] ">
        <img
    ...
    height="70"
        ...
        <div className="container relative mx-auto h-full flex flex-col justify-center px-4 text-white">
          <div className="max-w-2xl">
            ...
            <p className="text-xs sm:text-base md:text-lg mb-4 md:mb-8 opacity-90">
              A visionary new residential enclave that redefines luxury living
              in Dubai.
            </p>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 bg-black/40 backdrop-blur-md">
          <div className="container mx-auto">
            ...
            <div className="flex gap-4">
              ...
              />
              <Button className="bg-[#1a2b56] hover:bg-black text-white px-10">
                Search
              </Button>
            </div>
          </div>
      ...
      <div className="flex flex-col px-12 bg-white">
        ...
        <section className="py-12  sm:py-16 md:py-20">
          <div className="container mx-auto px-12">
            <div className="flex justify-between items-end mb-10">
              <h2 className="text-3xl font-bold text-[#1a2b56]">
                Premium Luxury Developments
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
              {luxuryDevelopments
                .slice(luxuryCarouselIndex, luxuryCarouselIndex + 3)
                .map((property, idx) => (
        ...
        <section className="relative h-48 sm:h-64 md:h-[300px] flex items-center">
          <Image
            src="/dubai-skyline-golden-hour.jpg"
            alt="Dubai Insights"
            fill
            className="object-cover"
          />
          ...
          <div className="container relative mx-auto px-4 text-white">
            ...
            <p className="mb-4 md:mb-8 opacity-80 max-w-xl text-xs sm:text-base">
              Comprehensive annual reports with key trends, prices, and
              forecasts.
            </p>
        ...
        <section className="py-12 sm:py-16 md:py-20 ">
          <div className="container mx-auto px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
              {latestLaunches
                .slice(launchCarouselIndex, launchCarouselIndex + 3)
                .map((property, idx) => (
                  <PropertyCard key={idx} {...property} />
                ))}
            </div>
        ...
        <section className="py-12 sm:py-16 md:py-20">
          <div className="container mx-auto px-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 md:mb-10 gap-4">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1a2b56]">
          ...
          <div className="container mx-auto px-4 flex flex-col lg:flex-row gap-8 md:gap-16 items-center">
            <div className="flex-1">
              ...
              <p className="text-xs sm:text-sm md:text-base text-gray-600 mb-4 md:mb-6">
                Step inside our world of luxury living. Explore exclusive
                property showcases, captivating virtual tours, and insightful
                expert guidance—all curated to bring you closer to the lifestyle
                you deserve.
              </p>
              <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
                <p className="text-xs sm:text-sm md:text-base font-medium text-gray-800">
                  ...
                  <span className="text-gray-500 font-normal">
                    Walk through some of the most stunning residences.
                  </span>
                </p>
                <p className="text-xs sm:text-sm md:text-base font-medium text-gray-800">
                  Lifestyle Insights -{" "}
                  <span className="text-gray-500 font-normal">
                    Discover what makes each community truly unique.
                  </span>
                </p>
                <p className="text-xs sm:text-sm md:text-base font-medium text-gray-800">
                  Expert Guidance -{" "}
          ...
          <div className="container mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            {[
              ...
              },
              {
                value: "200+",
                label: "Professionals",
                desc: "We have over 200 realtors and marketing professionals",
              },
              {
                value: "17+ YEARS",
                label: "Experience",
                desc: "We have been in the real estate business since 2008",
              },
              {
                value: "5,000+",
                label: "Happy Clients",
                desc: "We have served over 5000 happy clients since 2007",
              },
            ].map((stat, i) => (
              <div
                key={i}
                className="p-4 md:p-8 border rounded-xl hover:shadow-lg transition-shadow"
              >
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1a2b56] mb-2">
                  {stat.value}
                </div>
                <div className="font-bold mb-2 md:mb-4 text-sm md:text-base">
                  {stat.label}
                </div>
